...
## Performance: was this a good trawl?

```{r, echo = FALSE, eval=FALSE}
# conditions <- data.frame(weather = c("exellent", "good", "fair", "poor"), 
#                          touch_bottom = c("always", "always", "almost always", "variable"),
#                          performance = c(0, 0, 1, -1))
```
...
trials
# once you write your loop, you can use the following to calcuale the average the result of a roll of a die.  
